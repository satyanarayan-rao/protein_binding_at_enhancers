...
sec_peak_grey_bar_l=`echo "${17} - ${12}" | bc`
sec_peak_grey_bar_r=`echo "${17} + ${13}" | bc`
...
set obj rect from ${sec_peak_grey_bar_l}, graph 0 to ${sec_peak_grey_bar_r}, graph 1   
set output '${6}'
#set output '${15}'
