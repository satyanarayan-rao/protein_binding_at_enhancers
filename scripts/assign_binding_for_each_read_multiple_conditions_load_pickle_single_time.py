...
footprint_capped_dict = pickle.load(open(sys.argv[2], "rb"))
...
for job_k in job_id_pkl: 
    ...
    footprint_fp = open(job_id_pkl[job_k][1])
    out_fp_cond1 = open(job_id_pkl[job_k][2],"w") 
    out_fp_cond2 = open(job_id_pkl[job_k][3],"w") 
    out_fp_cond3 = open(job_id_pkl[job_k][4],"w")  
    out_fp_cond4 = open(job_id_pkl[job_k][5],"w")  
    out_fp_cond5 = open(job_id_pkl[job_k][6],"w")  
    out_fp_cond6 = open(job_id_pkl[job_k][7],"w")  
    per_methylation_vec_dict = pickle.load(open(job_id_pkl[job_k][8], "rb")) 
    out_fp_cond7 = open(job_id_pkl[job_k][9],"w")  
    out_fp_cond8 = open(job_id_pkl[job_k][10],"w")  
...
#footprint_capped_dict = pickle.load(open(sys.argv[13], "rb"))
    ...
    out_fp_cond8.close()
    footprint_fp.close()
    print ("\t".join(["Finished job", str(job_k)]))
