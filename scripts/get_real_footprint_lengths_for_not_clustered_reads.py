...
out_fp_percentage_methylation =  open(sys.argv[4], "w")
out_fp_percentage_methylation_pkl = open(sys.argv[5], "wb")
# for neighborhood analysis
footprint_dict = pickle.load(open(sys.argv[6], "rb")) 
extend_left_from_center = int(sys.argv[7]) 
extend_right_from_center = int(sys.argv[8]) 
strand = sys.argv[9]
